...
export class Rei extends Peca {
    ...
    testeParaRoque(posicao) {
        const possivelTorre = this.tabuleiro.Mostrapeca(posicao);
    ...
    movimentosPossiveis(posicao) {
        //Cima
        if ((this.posicao?.coluna === posicao.coluna) && (this.posicao?.linha - 1 === posicao.linha) && this.podeMover(posicao))
            return true;
        //NE
        if ((this.posicao?.coluna + 1 === posicao.coluna) && (this.posicao?.linha - 1 === posicao.linha) && this.podeMover(posicao))
            return true;
        //Direita
        if ((this.posicao?.coluna + 1 === posicao.coluna) && (this.posicao?.linha === posicao.linha) && this.podeMover(posicao))
            return true;
        //SE
        if ((this.posicao?.coluna + 1 === posicao.coluna) && (this.posicao?.linha + 1 === posicao.linha) && this.podeMover(posicao))
            return true;
        ...
        if (this.qtdMovimentos === 0) {
            //Roque Pequeno
            const posicaoVerificaTorre = this.Cor === Cor.Branca ? new Posicao(7, 7) : new Posicao(0, 7);
            ...
            //Roque Grande 
            const posicaoVerificaTorreRoqueGrande = this.Cor === Cor.Branca ? new Posicao(7, 0) : new Posicao(0, 0);
